...
This ChatGPT prompt guides you through all 5 questions, **rejects vague answers**, and runs a gameability check before declaring you ready.
...
5. After all 5 questions, ChatGPT stress-tests your metric for gameability
